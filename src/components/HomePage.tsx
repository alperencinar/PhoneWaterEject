...
export const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Scroll to tool section if coming from blog post
    if (location.state?.scrollToTool && toolSectionRef.current) {
      toolSectionRef.current.scrollIntoView({ behavior: 'smooth' });
    }
    
    return cleanup;
  }, [location.state?.scrollToTool]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <main className="container mx-auto px-4 py-8">
          <section ref={toolSectionRef} className="max-w-4xl mx-auto text-center mb-16">
